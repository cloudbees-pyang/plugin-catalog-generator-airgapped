...
curl -L https://jenkins-updates.cloudbees.com/update-center/envelope-core-mm/update-center.json?version=$CONTROLLER_VERSION -o ./$SCRIPT_PATH/update-center.json
sed -i '' -e '1 d' ./$SCRIPT_PATH/update-center.json
sed -i '' -e '$ d' ./$SCRIPT_PATH/update-center.json

curl -L https://jenkins-updates.cloudbees.com/update-center/core-mm-experimental/update-center.json?version=$CONTROLLER_VERSION -o ./$SCRIPT_PATH/update-center-experimental.json
